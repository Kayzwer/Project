                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('transactions.exportExpenses') }}" class="btn btn-sm btn-primary" style="color: white;">Export Expenses Data</a>
                                        ...
                                        <td class="td-actions text-right">
                                            ...
                                            @else
                                                ...
                                                <form action="{{ route('transactions.destroy', $transaction) }}" method="post" class="d-inline">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Delete Transaction" onclick="confirm('Are you sure you want to delete this expense ({{ $transaction->title }}, amount: {{ format_money($transaction->amount) }})?') ? this.parentElement.submit() : ''">
